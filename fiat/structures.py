"""
structures: workflow data structures
...
Sources: Type = Union[denovo.structures.DirectedGraph, 
...
class Workflow(denovo.structures.DirectedGraph):
    ...
    def append(self, item: Sources) -> None:
    ...
    def merge(self, item: Sources) -> None:
        """Adds 'item' to this Graph.

        This method is roughly equivalent to a dict.update, just adding the
        new keys and values to the existing graph. It converts the Sources
        formats to an adjacency list that is then added to the existing 
        'contents'.
        
        Args:
            item (Sources): another Graph, an adjacency list, an edge list, an 
    ...
    def prepend(self, item: Sources) -> None:
        ...
        Args:
            item (Sources): another DirectedGraph, an adjacency list, an edge 
